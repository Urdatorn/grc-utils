...
# This one does appear on wiktionary in the word Ὑ̄̆άδοιν, but will break my logic since it has both macron and breve.
# Maybe the original autor intended to imply that the length is unknown?
#    '\u1f59\u0304\u0306': 'Ὑ',  # Ὑ̄̆: GREEK CAPITAL LETTER UPSILON WITH DASIA + COMBINING MACRON + COMBINING BREVE TODO: 14/03 found in wikt by AI